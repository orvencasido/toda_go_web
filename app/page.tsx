      ...
      {activeTab === "profile" && (
        <div className="absolute inset-0 bg-[#bde5ff] flex items-start justify-center p-4 py-12 overflow-y-auto z-40 transition-all">
          ...
          {showChangePictureSubModal && (
            <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center z-50 p-4 transition-all animate-in fade-in duration-200">
              <div className="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-100 p-6 flex flex-col gap-4">
                <h3 className="text-[#091b6f] font-bold text-lg">Change Profile Picture</h3>
                ...
                <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Or Select Color Theme Accent</h4>
                <p className="text-[10px] text-slate-400 font-semibold mb-1">Reverts custom picture to show the default SVG styled avatar.</p>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`border rounded-2xl p-3 flex flex-col items-center gap-2.5 transition-all hover:scale-[1.02] cursor-pointer ${!adminProfile.avatarUrl && adminProfile.avatarColor === theme.color
